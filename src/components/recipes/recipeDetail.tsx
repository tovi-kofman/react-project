...
const RecipeDetail = () => {
    ...
    return (
        <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "calc(100vh - 2cm)", backgroundColor: "#f5f5f5", padding: 2 }}>
            <Paper elevation={4} sx={{ maxWidth: '50%', width: '800px', padding: 2, borderRadius: 3, backgroundColor: "white" }}>
                <Card sx={{ bgcolor: "#ffffff", borderRadius: 3, boxShadow: 2 }}>
                    <CardContent>
                        ...
                        <Box sx={{ maxHeight: 200, overflowY: 'auto', border: '1px solid #ddd', padding: 1 }}>
                        ...
                        <Box sx={{ maxHeight: 180, overflowY: 'auto', border: '1px solid #ddd', padding: 1 }}>
